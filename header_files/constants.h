    ...
    #define EDIT_PKMN_LEVEL 2
    #define EDIT_PKMN_EXP 3
    #define EDIT_PKMN_ID_MOVE_1 4
    #define EDIT_PKMN_ID_MOVE_2 5
    #define EDIT_PKMN_ID_MOVE_3 6
    #define EDIT_PKMN_ID_MOVE_4 7
